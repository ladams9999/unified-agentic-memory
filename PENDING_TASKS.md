...
- [ ] **SP1** — Add named runtime profiles with explicit selection, default fallback, and profile-scoped memory prefixes/config resolution for hooks and CLI surfaces.
